    ...
    <div class="card-body">
        <form action="{{ route('locker.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('locker_name') is_invalid @enderror" value="{{ old('locker_name') }}" placeholder="Enter your code" name="locker_name" required>
                @error('locker_name')
